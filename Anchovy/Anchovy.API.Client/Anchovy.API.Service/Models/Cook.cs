...
namespace Anchovy.API.Client.Models
{
    public partial class Cook
    {
        ...
        {
            get { return this._hourlyWage; }
            set { this._hourlyWage = value; }
        }
        ...
        private double? _pieceworkRate;
        
        /// <summary>
        /// Optional.
        /// </summary>
        public double? PieceworkRate
        {
            get { return this._pieceworkRate; }
            set { this._pieceworkRate = value; }
        }
        ...
        public virtual void DeserializeJson(JToken inputObject)
        {
            if (inputObject != null && inputObject.Type != JTokenType.Null)
            {
                ...
                JToken hourlyWageValue = inputObject["HourlyWage"];
                if (hourlyWageValue != null && hourlyWageValue.Type != JTokenType.Null)
                {
                    this.HourlyWage = ((double)hourlyWageValue);
                }
                ...
                if (managerValue != null && managerValue.Type != JTokenType.Null)
                {
                    ...
                    manager.DeserializeJson(managerValue);
                    this.Manager = manager;
                }
                JToken managerIdValue = inputObject["ManagerId"];
                if (managerIdValue != null && managerIdValue.Type != JTokenType.Null)
                {
                    this.ManagerId = ((int)managerIdValue);
                }
                ...
                JToken pieceworkRateValue = inputObject["PieceworkRate"];
                if (pieceworkRateValue != null && pieceworkRateValue.Type != JTokenType.Null)
                {
                    this.PieceworkRate = ((double)pieceworkRateValue);
                }
        ...
        /// </summary>
        /// <returns>
        /// Returns the json model for the type Cook
        /// </returns>
        public virtual JToken SerializeJson(JToken outputObject)
        {
            ...
            {
                outputObject["HourlyWage"] = this.HourlyWage.Value;
            }
            if (this.Id != null)
            {
            ...
            {
                outputObject["Manager"] = this.Manager.SerializeJson(null);
            }
            if (this.ManagerId != null)
            {
                outputObject["ManagerId"] = this.ManagerId.Value;
            }
            ...
            if (this.PieceworkRate != null)
            {
                outputObject["PieceworkRate"] = this.PieceworkRate.Value;
            }
            if (this.State != null)
            {
